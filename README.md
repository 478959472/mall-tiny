...
<mapper namespace="com.montnets.creation.platform.modules.ums.mapper.UmsMenuMapper">

    <select id="getMenuList" resultType="com.montnets.creation.platform.modules.ums.model.UmsMenu">
        SELECT
            m.id id,
